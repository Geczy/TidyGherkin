...
function launchSupport() {
	window.open("http://twitter.com/testanalyst");
}

function launchReview() {
	window.open("https://chrome.google.com/webstore/detail/tidy-gherkin/nobemmencanophcnicjhfhnjiimegjeo/reviews");
}
...
function showVersionInfo() {
	vex.dialog.alert("<h1>Version 0.4.6</h1>" +
						"<p>NEW in this version:</p>" +
						"<ul>" +
						"<li><p>New feature: Support for auto-generation of Javascript step definitions.</p></li>" +
						"</ul>");
	return;
}
